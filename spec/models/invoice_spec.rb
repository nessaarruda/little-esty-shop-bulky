...
RSpec.describe Invoice, type: :model do
  ...
  describe "instance methods" do
    ...
    expect(i1.find_discount_id(ii_1.quantity)).to eq(discount1.id)
    end
  #   it 'find items' do
  #     m1 = Merchant.create!(name: 'Merchant 1')
  #     m2 = Merchant.create!(name: 'Merchant 2')
  ...
  #     id2 = ii_2.id
  #     id3 = ii_3.id
  #     result = {id1 => item_1.id, id2 => item_2.id, id3 => item_3.id}
  #     expect(i1.find_items).to eq(result)
  end
end
