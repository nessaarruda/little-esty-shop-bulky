...
RSpec.describe Invoice, type: :model do
  ...
  describe "instance methods" do
    ...
    it 'can check for discounts for invoices' do
      ...
      discount4 = m2.bulk_discounts.create!(name: 'D', percentage: 0.30, quantity: 30)
      ...
      expect(i1.check_discount(ii_1.quantity, item_1.id)).to eq(108)
      expect(i2.check_discount(ii_2.quantity, item_2.id)).to eq(128)
    end
  end
end
